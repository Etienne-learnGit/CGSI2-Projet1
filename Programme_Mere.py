...
def initialisation():
    ...
    number -= 1
    lstChoice = ["Maillage\Rectangular_HULL_Normals_Outward.stl","Maillage\V_HULL_Normals_Outward.stl", "Maillage\Mini650_HULL_Normals_Outward.stl","Maillage\Cylindrical_HULL_Normals_Outward.stl"]
