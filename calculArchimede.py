...
#boat1 = extractionSTL("Maillage\Rectangular_HULL_Normals_Outward.stl")
#boat1 = extractionSTL("Maillage\V_HULL_Normals_Outward.stl")
boat1 = extractionSTL("Maillage\Cylindrical_HULL_Normals_Outward.stl")
